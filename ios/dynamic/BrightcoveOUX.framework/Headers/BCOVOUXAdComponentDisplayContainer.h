//
// BCOVOUXAdComponentDisplayContainer.h
// BrightcoveOUX
//
...
@class BCOVAd;
@protocol BCOVOUXAdComponentDelegate;


NS_ASSUME_NONNULL_BEGIN

/**
 * This class is used to display the ad UI and handle companion ads for BCOVOUX.
 *
 ...
 */
@property (nullable, nonatomic, weak) id<BCOVOUXAdComponentDelegate> delegate;
...
@interface BCOVOUXAdComponentDisplayContainer (Unavailable)

- (nullable instancetype)init __attribute__((unavailable("Use `-[BCOVOUXAdComponentDisplayContainer initWithAdComponentContainer:companionSlots:]` instead.")));
