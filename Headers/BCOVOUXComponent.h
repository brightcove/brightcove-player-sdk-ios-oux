 ...
 */
- (id<BCOVPlaybackController>)createOUXPlaybackControllerWithViewStrategy:(BCOVPlaybackControllerViewStrategy)strategy;
 ...
 */
- (id<BCOVPlaybackSessionProvider>)createOUXSessionProviderWithOptions:(BCOVOUXSessionProviderOptions *)options;
