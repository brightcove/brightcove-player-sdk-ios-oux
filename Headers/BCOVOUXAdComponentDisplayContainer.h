 ...
 */
- (instancetype)initWithAdComponentContainer:(UIView *)adComponentContainer companionSlots:(NSArray *)companionSlots NS_DESIGNATED_INITIALIZER;

/**
 * The delegate for the BCOVOUXAdComponentDisplayContainer.
 */
@property (nonatomic, weak) id<BCOVOUXAdComponentDelegate> delegate;
