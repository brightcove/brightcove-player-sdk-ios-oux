...
@interface BCOVOUXCompanionSlot (Unavailable)

- (nullable instancetype)init __attribute__((unavailable("Use `-[BCOVOUXCompanionSlot initWithView:width:height:]` instead.")));
